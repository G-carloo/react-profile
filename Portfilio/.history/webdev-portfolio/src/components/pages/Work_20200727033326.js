      ...
      <div className='carousel-inner carousel-fade'>
        <div className='carousel-item active'>
          ...
          <div class='carousel-caption '>
            <h4 className='b'>Jason Wandrag</h4>
            <p className='b'>
        ...
        <div className='carousel-item '>
          ...
          />
          <div class='carousel-caption '>
            <h4 className='b'> Philani Sithembiso Ndhlela</h4>
            <p className='b'>
              {" "}
        ...
        <div className='carousel-item '>
          ...
          <div class='carousel-caption '>
            <h4 className='b'>Moghamed Junaid Salie</h4>
            <p className='b'>
              <strong>
        ...
        <div className='carousel-item '>
          ...
          <div class='carousel-caption '>
            <h4 className='b'>Micheal bruwer</h4>
            <p className='b'>
