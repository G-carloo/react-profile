    ...
    >
      ...
      <div class='carousel-inner'>
        ...
        <div class='carousel-item'>
          <img class='d-block w-100' src={Philani} alt='Second slide' />
        </div>
        <div class='carousel-item'>
          <img class='d-block w-100' src={Junaid} alt='Third slide' />
        </div>
        <div class='carousel-item'>
          <img class='d-block w-100' src={Michael} alt='Fourth slide' />
        </div>
        <div class='carousel-item'>
